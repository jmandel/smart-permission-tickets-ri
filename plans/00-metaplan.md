...
- Phases 1 through 4 are implemented on `main`, including the explicit verifier-side issuer-trust policy model, the direct-JWKS default runtime path, and the JWKS + OIDF cross-source consistency tripwire
